...
public class AIServiceImpl implements AIService {
    ...
    public void autoReply(InteractionQuestion interactionQuestion) {
        ...
        // 调用AI文本生成服务获取专业回答
        String reply = aigcClient.chatText(question);
        ...
        // 持久化存储生成的回复
        UserContext.setUser(aiUserId);
        replyDTO.setTargetUserId(interactionQuestion.getUserId());
        iInteractionReplyService.addReply(replyDTO);
    }
