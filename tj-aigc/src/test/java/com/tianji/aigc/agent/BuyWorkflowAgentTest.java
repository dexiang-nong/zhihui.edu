...
@SpringBootTest
class BuyWorkflowAgentTest {

    @Resource
    private BuyWorkflowAgent buyWorkflowAgent;

    @Test
    public void processStream() throws InterruptedException {
        String question = "下单购买，课程id为：1";
        String sessionId = "a7ed4c24ea33492ba48fe25649fa873b";
        UserContext.setUser(2L);
        Flux<ChatEventVO> flux = buyWorkflowAgent.processStream(question, sessionId);
